...
def philosopher_response(topic: str, round_num: int, memory: dict) -> str:
     # Include a brief rolling context from memory (last ~6 lines) to keep the debate coherent.
...
Round {round_num} response:"""
    ...
    try:
        ...
        raise RuntimeError(f"Together API call failed for Philosopher (round {round_num}): {e}") from e
